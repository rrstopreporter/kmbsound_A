...
function switchPidsMode(val) {
    ...
    if (pidsMode === '19') {
        ...
        pids.style.height = "280px";
        pids.style.border = "15px solid #111"; 
        pids.style.borderRadius = "16px";
        scaleWrapper.style.transform = "scale(0.625)"; 
        if (outerContainer) outerContainer.style.height = "220px"; 
        if (sticker) { sticker.style.left = "300px"; sticker.style.bottom = "10px"; }
    } else {
        // 24吋標準模式
        pids.style.width = "800px";
...
/* =========================================
   ★ PIDS 渲染函數 (19 吋 3 站模式)
   ========================================= */
function renderPids19Inch(text, isEng) {
    const pids = document.getElementById("pidsScreen");
    ...
    if (isAlert) {
        ...
        // ★ 第二、三行 (加入 overflow: hidden 同埋 margin-bottom: -12px 嘅絕對定位)
        bottomHalfHtml = `
            <!-- 第二行 (下一站 25%) -->
            <div style="display: flex; height: 25%; width: 100%; box-sizing: border-box;">
                ...
                <div style="width: 86%; height: 100%; background: #fff; position: relative; overflow: hidden; box-sizing: border-box; border-bottom: 2px solid #e0e0e0;">
                   ...
                   <div style="position: absolute; top: 0px; z-index: 10;">
                       <div class="auto-box-left" style="width: 100%; margin-left: 5px; margin-bottom: -12px;"><div class="auto-text-left" style="font-size: 48px; font-family: '微軟正黑體', sans-serif; color: #000; font-weight: bold;">${n2.tc}</div></div>
            ...
            <div style="display: flex; height: 25%; width: 100%; box-sizing: border-box;">
                ...
                <div style="width: 86%; height: 100%; background: #fff; position: relative; overflow: hidden; box-sizing: border-box;">
                   ...
                   <!-- ★ 絕對定位鎖死，靠 -12px 將字拉埋 -->
                   <div style="position: absolute; top: 0px; z-index: 10;">
                       <div class="auto-box-left" style="width: 100%; margin-left: 5px; margin-bottom: -12px;"><div class="auto-text-left" style="font-size: 48px; font-family: '微軟正黑體', sans-serif; color: #000; font-weight: bold;">${n3.tc}</div></div>
              ...
              <div style="display: flex; justify-content: center; align-items: center; width: 100%; height: 100%; box-sizing: border-box; padding: 0 5px;">
                  <div style="display: flex; align-items: center; max-width: 100%; flex-shrink: 1;">
                      <div style="display: flex; flex-direction: column; justify-content: center; align-items: center; margin-right: 6px; line-height: 1.1; flex-shrink: 0;">
                          ...
                          <div style="font-family: Noto Sans HK, sans-serif; font-size: 20px; font-weight: bold;">Route</div>
                      </div>
                      ...
                      <div style="display: flex; flex-direction: column; justify-content: center; align-items: flex-start; line-height: 1.1; overflow: hidden; flex-shrink: 1; min-width: 0;">
                          ...
                          <div class="auto-box-left" style="height: 50%; width: 100%;"><div class="auto-text-left" style="font-size: 24px; font-family: Noto Sans HK, sans-serif; font-weight: 900; transform-origin: left center;">${activeRouteObj.pidsDestEn.toUpperCase()}</div></div>
                      </div>
                  </div>
              </div>
          </div>
...
function updatePidsScreen() {
  try {
      ...
      if (currentMode === "RUNNING") {
          ...
          if (pidsMode === '19') {
              renderPids19Inch(initText, initIsEng);
          } else {
